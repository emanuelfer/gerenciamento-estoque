 ...
 * @author emanu
 */
public class TelaCadastrarFornecedora extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaCadastroFornecedora
     */
    public TelaCadastrarFornecedora() {
        initComponents();
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if(nome != "" && cnpj != 0 && endereco != ""){
            ...
            Fornecedora fornecedora = new Fornecedora(nome, cnpj, endereco);
            try{
                df.create(fornecedora);
